const S = {
  th: {
    ...
    DELIVERED: 'อยู่ระหว่างการจัดส่ง',
  ...
  en: {
    ...
    REFUND_REJECT_REASON: 'Reject Reason',
    ORDER_ITEMS: 'Items',
