...
const IntownRoute = props => {
  ...
  const showEditDeliveryPriceDialog = useShowEditDeliveryPriceDialog(
    config.delivery.intownPrices, handleSubmit
  );
  const data = useDeliveryPrice('intownPrices');
  return <>
    <H1>Delivery Price for Intown</H1>
    <CardContainer>
